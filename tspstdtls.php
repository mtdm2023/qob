...
<body class="tspstdtls TSWView tsrtl  position-relative">
	...
	<!-- Topbnr -->
	<section id="tssection-tstopslider" class="tsc-sec-tstopslider w-100 h-auto pt-md-5 pt-2">
		<div class=" tsaboutustsc-slider-container position-relative p-0 pt-2">

			<div class="slider_container position-relative w-100 h-100	">
				<!--******** navigation buttons ********-->
				<div
					class="nav d-flex justify-content-between align-items-center position-absolute top-50 translate-middle-y w-100 h-100 z-1 px-1">
					<div class=" tsc-cursorpointer CarouselNav_btn navbtn_right tsbg-0 px-md-3 py-md-3 px-2 py-2">
						<img class="home__top_slider_arrow p-md-1 p-0 " src="./tsimg//qobon-home-topslider-arrowright.svg" alt="">
					</div>
					<div class="tsc-cursorpointer CarouselNav_btn navbtn_left  tsbg-0 px-md-3 py-md-3 px-2 py-2">
						<img class="home__top_slider_arrow p-md-1 p-0 " src="./tsimg//qobon-home-topslider-arrowleft.svg" alt="">
					</div>
				</div>

				<!-- ******** slider ******** -->
				<div class="owl-carousel owl-theme SliderX">
					<div class="tsitem  w-100 position-relative   ">
						<a href="#" class="w-100 h-100 position-relative">
							<img class="w-100" src="./tsimg/qobon-home-topslider-bg.png" alt="">
							<style>
								.tsc-sec-tstopslider .tsitem img {
	...
	<!-- tspstslist-->
	<section id="tssection-tspstslist" class="tsc-sec-tspstslist w-100 h-auto pt-md-4 pt-2">
